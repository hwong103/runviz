...
export function RunDetails({ activity: initialActivity, allActivities, shoes, onClose, onSelect }: RunDetailsProps) {
    ...
    return (
        <div className="fixed inset-0 z-[100] overflow-y-auto bg-[color-mix(in_srgb,var(--rv-bg)_90%,transparent)] p-2 sm:p-4 backdrop-blur-xl">
            <div
                role="dialog"
                aria-modal="true"
            ...
            >
                <div className="border-b border-white/6 bg-black/10 px-4 py-4 sm:px-7">
                    <div className="grid gap-3 sm:gap-4 [grid-template-columns:minmax(0,1fr)_auto]">
                        <div className="min-w-0">
                            <span className="rv-kicker">Run Details</span>
                        </div>

                        <div className="flex shrink-0 items-center gap-2 justify-self-end self-start">
