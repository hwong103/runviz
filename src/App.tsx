      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 flex items-center justify-center p-4">
        <div className="max-w-md w-full text-center">
          <div className="bg-white/5 backdrop-blur-xl rounded-3xl p-8 border border-white/10 shadow-2xl">
            ...
            <button
              onClick={login}
              className="w-full bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white font-bold py-4 px-8 rounded-2xl transition-all duration-300 transform hover:scale-[1.02] active:scale-[0.98] shadow-xl shadow-orange-500/20 flex items-center justify-center gap-3"
            >
            ...
            <div className="mt-10 grid grid-cols-2 gap-4 text-left">
              <div className="p-3 rounded-xl bg-white/5 border border-white/5">
                ...
                <span className="text-xs text-gray-500 uppercase font-bold tracking-widest">Analytics</span>
              </div>
              <div className="p-3 rounded-xl bg-white/5 border border-white/5">
                <span className="text-cyan-400 block font-bold text-lg">SMASHRUN</span>
                <span className="text-xs text-gray-500 uppercase font-bold tracking-widest">Parity</span>
              </div>
            </div>
          </div>
        </div>
    ...
    <div className="min-h-screen bg-[#0a0c10] text-gray-200">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3 pl-4 border-l border-white/10 text-sm">
              <span className="text-gray-400 hidden lg:inline">Welcome back,</span>
          ...
          <div className="flex items-center gap-4">
            {viewPeriod.mode !== 'all' && (
              <select
                ...
                className="bg-black/60 text-white px-4 py-3 rounded-xl border border-white/10 outline-none focus:border-emerald-500 transition-colors font-bold"
              >
            ...
            {lastSync && (
              <div className="text-[10px] text-gray-500 uppercase font-black tracking-widest hidden sm:block">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white/5 rounded-3xl p-8 border border-white/10">
              <h3 className="text-xl font-bold text-white mb-6">Activity Frequency</h3>
              <CalendarHeatmap activities={activities} year={viewPeriod.mode !== 'all' ? viewPeriod.year : undefined} month={viewPeriod.mode === 'month' ? (viewPeriod.month ?? undefined) : undefined} />
            </div>
          </div>
      ...
      <footer className="border-t border-white/5 py-12 bg-black/40">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <div className="text-gray-500 text-xs font-bold uppercase tracking-[0.2em] mb-4">RunViz v0.1.0 Alpha</div>
          <p className="text-gray-600 text-sm">
            Powered by Strava API. Built for the community.{' '}
            <a href="https://github.com/hwong103/runviz" className="text-emerald-500 hover:text-emerald-400 transition-colors font-bold">Open Source</a>
          </p>
        </div>
      </footer>
    </div>
